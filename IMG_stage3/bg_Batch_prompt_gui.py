"""
bg_Batch_prompt_gui.py

Stage 3-2: 전처리 -> AI배경생성 분석 작업 (배치/대량)
- 기능: Batch JSONL 생성 -> 업로드 -> 실행 -> 결과 병합
- bg_prompt_core.py를 사용하여 배치 처리
- 입력: I2 또는 I3 파일만 허용
- 출력: 항상 I4로 고정
"""
...
class BGPromptBatchGUI(tk.Tk):
    def __init__(self):
        super().__init__()
        self.title("Stage 3-2: 전처리 -> AI배경생성 분석 작업 (배치/대량)")
