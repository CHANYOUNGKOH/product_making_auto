...
from hub.routers import dashboard, products, pipeline, export, stores, vendors, catalog, register, market_status, image_genai
...
app.include_router(image_genai.router)
